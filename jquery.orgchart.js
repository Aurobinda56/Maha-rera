(function($) {
    ...
    $.fn.orgChart.defaults = {
        data: [{id:1, name:'Root', parent: 0,num:1}],
        showControls: false,
        allowEdit: false,
        onAddNode: null,
        onDeleteNode: null,
    ...
    function OrgChart($container, opts){
        ...
        this.draw = function(){
            ...
            $('.org-building-button').click(function (e) {
              var thisId = 1;
            ...
            $(".org-Wings-button").click(function (e) {
              let buildingNum = prompt("In Which Building You want to add the Wings", "1");
              var thisId = buildingNum;
            ...
            $(".org-floor-button").click(function (e) {
              let buildingNum = prompt("In Which Building You want to add the Floor","1");
              var thisId = buildingNum;
            ...
            $(".org-unit-button").click(function (e) {
              let buildingNum = prompt("In Which Wings You want to add the Unit","4");
              var thisId = buildingNum;
    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            //   descNum = "<p>" + self.data.num + "</p>";
            // }
            if(opts.showControls){
                var buttonsHtml =
                  "<div class='org-add-button'>" +
                  opts.newNodeText +
                  "</div><div class='show-num-button'>"+this.data.id+"</div><div class='org-del-button'></div>";
            } else {
              buttonsHtml = "";
            }
